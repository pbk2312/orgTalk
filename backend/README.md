...
실시간 채팅 서비스를 위한 백엔드 시스템입니다. GitHub OAuth2 인증을 통한 멤버 관리, 그리고 WebSocket 기반의 실시간 채팅 기능을 제공합니다.
...
DevTalk은 GitHub 계정으로 로그인하여 사용할 수 있는 실시간 채팅 플랫폼입니다. 사용자는 GitHub OAuth2를 통해 로그인하고, 채팅방을 생성하고 참여하여 실시간으로 소통할 수 있습니다.
