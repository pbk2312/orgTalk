...
@Table(
    indexes = {
        @Index(name = "idx_chatroom_org_type", columnList = "organizationId, type"),
        @Index(
            name = "idx_chatroom_orgid_type_created_updated",
            columnList = "organizationId, type, createdAt, updatedAt"
        )
    }
)
