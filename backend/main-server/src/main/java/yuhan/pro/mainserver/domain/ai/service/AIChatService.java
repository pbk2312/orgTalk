...
public class AIChatService {
    ...
    public ChatResponse getAnswer(ChatRequest request) {
        try {
            ...
            OpenAIRequest openAIRequest = OpenAIRequest.createDeveloperAssistant(request.question());
            ...
            log.error("OpenAI API 호출 실패 - 상태 코드: {}, 응답: {}", e.getStatusCode(), e.getResponseBodyAsString());
